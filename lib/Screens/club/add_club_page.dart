...
class _AddClubPageState extends ConsumerState<AddClubPage> {
  ...
  Future<void> _refresh() async {
    await ref.refresh(clubProvider(
            "?college=${widget.collegeId}&college_status[\$ne]=rejected&members[\$ne]=${widget.userId}")
        .future);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('Join or Create Club'),
                    ...
                    if (index == 0) {
                      return Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                _buildAddClubCard(Icons.add_outlined,
                                    "Create new club"),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => ClubForm1Activity(
                  collegeId: widget.isCollegeAdmin ? widget.collegeId : null,
                ),
              ));
        },
        child: Card(
